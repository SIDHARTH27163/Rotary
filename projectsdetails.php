...
$sql = "SELECT * FROM pmonth where projectid='$asid'";
...
<tbody>
  <tr>
              ...
              <?php include './admin/dbConfig/dbconfig.php';
                    $query = "SELECT * FROM projectdet where gname='$aname' and aid = '$year'  group by title";
              ...
              $title = $row['title'];
                  ...
                  <br>
                        ...
                        <?php $query2 = "SELECT * FROM projectdet where  title='$title' ";
                        ...
                        ?>
                        <center><img height="20%" width="50%" src="<?php echo $location.$row2['gimages']?>"  alt="<?php $row2['gimages']?>"></center>
                        
                        
                        <hr>
                       <?php if($row2['page_link'] != 0){?>
                       <!--<h1>-->
                       <!--    enabled-->
                       <!--</h1>-->
                       <a target="_blank" href="<?php echo($row2['page_link']);?>">View Gallery</a>
                 ...
                 <?php 
                  ...
                  <tfoot class="bg-dark">
                   <tr> <th><a href="projects.php"<i style='color:white;'class='fa fa-arrow-circle-o-left' aria-hidden='true'></i>  Back to Projects / Events</a></th></tr>
                  </tfoot>
                  </table>
