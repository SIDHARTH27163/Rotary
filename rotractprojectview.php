...
<head>
    ...
    <title>Projects / Events View | Rotract Club of Dharamshala</title>
...
$sql = "SELECT * FROM rotractprojectyear where id='$aid'";
...
<tbody>
  <tr>
              ...
              <?php include './admin/dbConfig/dbconfig.php';
                    $query = "SELECT * FROM rotractpmonth where pid=$aid and status='process'";
                     $query_run = mysqli_query($connection,$query);
                /*     $location= "admin/uploads/admin/Gallery/pupload/";  */
                 $location= "admin/uploads/admin/Gallery/rotpupload/";
                ...
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 portfolio-item">
                    <div class="portfolio-one">
                        <div class="portfolio-head">
                            <div class="portfolio-img">
                              <a href="<?php echo $location.$row['image']?>" data-lightbox="rcdGallery" data-title="<?php echo $row['name']?>">
                                <img alt="<?php echo $row['name']?>" src="<?php echo $location.$row['image']?>">
                              </a>
                            </div>
                        </div>
                        <!-- End portfolio-head -->
                        <div class="portfolio-content">
                            <h5 class="title"><span><?php echo htmlentities($row['name']);?></span></h5>
                            <p><?php echo"<a href='rotractprojectdetails.php?id=$asid'> <button type='submit' class='btn btn-warning' name='view_more'>View   <i style='color:white;'class='fa fa-arrow-circle-o-right' aria-hidden='true'></i></button></a>"?></p>
                  ...
                  <tfoot class="bg-dark">
                 <!--  <tr> <th><a href="projects.php"<i style='color:white;'class='fa fa-arrow-circle-o-left' aria-hidden='true'></i>  Back</a></th></tr>
                 -->
