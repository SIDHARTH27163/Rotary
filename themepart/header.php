            ...
            <div class="row">
                <div class="col-md-8 col-sm-8 col-xs-8 top-header-links">
                    <ul class="contact_links">
                        <?php
                        include 'admin/dbConfig/dbconfig';
				...
				<span class="icon-bar"></span>
                    ...
                    <div id="navbar" class="collapse navbar-collapse navbar-right">
                        <ul class="nav navbar-nav">
                            <li class="active nav-item"><a href="index">Home</a></li>
                                    <li class="nav-item dropdown"><a href="#" class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-expanded="true">About Rotary <span class="caret"></span></a>
                            ...
                            <li class="nav-item"><a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Rotary Dharamshala <span class="caret"></span></a>
                                        <ul class="dropdown-menu" role="menu">
                                                 <li class="dropdown-item"><a href="aboutus">About us</a>
                                                </li>
                                                <div class="divider"></div>
                                                <li class="dropdown-item"><a href="charter_members">Charter Members</a>
                                                </li>
                                                <div class="divider"></div>
                                                <li class="dropdown-item"><a href="dis_tr_ict_gov_ners">District Governor</a>
                                                </li>
                                                <div class="divider"></div>
                                                <li class="dropdown-item"><a href="bod">Board of Directors</a>
                                                </li>
                                                <div class="divider"></div>
                                                <li class="dropdown-item"><a href="rollofhonor">Roll of Honor</a>
                                                </li>
                                                <div class="divider"></div>
                                                <li class="dropdown-item"><a href="Paul_Harris_F">Paul Harris Fellows</a>
                                                </li>
                                                <div class="divider"></div>
                                                <li class="dropdown-item"><a href="cmsrid">Club Members Serving in RI Distt. 3070</a>
                                                </li>
                                                <div class="divider"></div>
                                                <li class="dropdown-item"><a href="members">Members</a>

                                                </li>
                                                <div class="divider"></div>
                                                <li class="dropdown-item"><a href="loc">List of Contributors</a>
                                                </li>
                                                    <div class="divider"></div>
                                                <li class="dropdown-item"><a href="pauhsm">Paul Harris Sustaining Members</a>
                                                </li>
                                                <div class="divider"></div>
                                                <li class="dropdown-item"><a href="ccm">Club Committees</a>
                                                </li>
                                        </ul>
                             </li>
                            ...
                            <li class="nav-item"><a href="mediayear">Media</a></li>
