  ...
  $result = $connection->query($query1);
    ...
    if ($result->num_rows > 0) 
    {
        ...
        echo "0 results";
                  ...
                  $query = "INSERT INTO boardofdirec(bo_id,bod_session,Mem_id,designation,name,contact,year,status , image) VALUES ('".$bo_id."','".$bod_session."','".$mem_id."','".$designation."', '".$name."', '".$contact."',NOW(),'".$status."','".$image."')";
//      echo $query;
      $query_run = mysqli_query($connection,$query);

      if($query_run){

                        echo " <div class='alert alert-success mydiv'>Board of Director member  $name Successfully Added.</div>";
