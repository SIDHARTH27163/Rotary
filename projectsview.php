...
<head>
    ...
    <title>Projects / Events View | Rotary Club of Dharamshala</title>
...
$sql = "SELECT * FROM projectyear where id='$aid'";
...
<tbody>
  <tr>
              ...
              <?php include './admin/dbConfig/dbconfig.php';
                    $query = "SELECT * FROM pmonth where pid=$aid and status='process'";
                ...
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 portfolio-item">
                    <div class="portfolio-one">
                        ...
                        <div class="portfolio-content">
                            ...
                            <p><?php echo"<a href='projectsdetails.php?id=$asid'> <button type='submit' class='btn btn-warning' name='view_more'>View   <i style='color:white;'class='fa fa-arrow-circle-o-right' aria-hidden='true'></i></button></a>"?></p>
