...
<head>
  ...
  <title>Charter Member Image Edit | Rotary Club Dharamshala</title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Charter Members : Image Updater</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">RCD : Charter Members Image Updater</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
if(isset($_POST['submit']))
   ...
   $query= "UPDATE charter_members SET image='$edit_images' WHERE cid = '$mykey1'";
            ...
            if($query_run)
      {
         move_uploaded_file($filetmp,$location.$edit_images);
                        ...
                        echo "<script>location.href='viewcm.php?ids=$asid2'</script>";
      }
