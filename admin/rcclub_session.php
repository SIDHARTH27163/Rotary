          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Rotract Club</li>
                      ...
                      $query_session = "SELECT * FROM rc_session Where rcsession='$dmb_session'";
                      ...
                      $query="INSERT INTO rc_session(rcsession,date,status) VALUES ('$dmb_session',Now(),'$status')";
                      ...
                      if($query_run)
                        {
                          ...
                          echo " <div class='alert alert-success mydiv'>Your New Session for Rotract Team Is Successfully Added. Go For Step 2.</div>";
                        }
                        else
                        {
              ...
              <section class="content">
                    ...
                    <div class="card">
                      <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 1.</b> Add Rotract Team Session.</h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                                              ...
                                              <hr>
                                              <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 2.</b> Choose session year to add Rotract Team </h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                      
                      
                                            <form action="rcclink.php" method="post" enctype="multipart/form-data" name="upload">
