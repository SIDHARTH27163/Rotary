    <div class="modal fade" id="AdminModal<?php echo $row['mgid'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="update_album">Update Matching Grants Details</h5>
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="id" value="<?php echo $row['mgid'] ?>">
            <div class="modal-body">
        
         <div class="form-group">
         <label> Name Of The PHF</label>
          <input type="text" name="phfn" class="form-control" value="<?php echo $row['code']?>"  required>

          <p class="help-block ">Example : "ABC12345" </p>
          
        </div>
         <div class="form-group">
        <label> Comment</label>
          <input type="text" name="comment" class="form-control" value="<?php echo $row['descr'] ?>"  required>
        ...
        <div class="form-group">
        <label> Amount</label>
          <input type="text" name="amnt" class="form-control" value="<?php echo $row['amnt'] ?>"  required>
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="dm_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
