<div class="modal fade" id="AdminModal<?php echo $row['mgfid']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="update_album">Update Matching Grants footer Details</h5>
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="id" value="<?php echo $row['mgfid'] ?>">
            <div class="modal-body">
        
         <div class="form-group">
         <label> TITLE</label>
          <input type="text" name="phfn" class="form-control" value="<?php echo $row['title']?>"  required>
