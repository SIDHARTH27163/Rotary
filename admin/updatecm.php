<div class="modal fade" id="AdminModal<?php echo $row['cid'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="cm_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
