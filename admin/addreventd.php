...
$sql = "select * from r_cover where reid='$agid'";
$rs_result = mysqli_query ($connection,$sql);
?>
<?php
while ($row = mysqli_fetch_assoc($rs_result)) {
?>
<?php $aname=$row["revent_name"]; ?>
<?php };?>
                  ...
                  if(!in_array($extension_check,$allowed_extensions))
                          {
                           echo " <div class='alert alert-danger mydiv'><strong>ERROR</strong> - Invalid format. Only jpg / jpeg/ png  format allowed</div>";
                               ...
                               else
                               {
                                ...
                                $query="INSERT into revent_desc(`reid`,`images`,`desc`,`status`) VALUES('$gid','$file_name','$desc','$status')";
