...
<head>
  ...
  <title>CMSRID VIEW | Rotary Club Dharamshala</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Rotary Club Of Dharamshala : CMSRID</h1>
          </div>          
          <div class="col-sm-6">
...
$sql = "select * from cmsrid where status='process'";
$rs_result = mysqli_query ($connection,$sql);
echo "
<select class='form-control' name='cod_name'>";
