...
<head>
  ...
  <title>Rotaract Club Dharamshala -Add Projects  | Projects</title>
...
?>
                    <div class="card">
                      ...
                      <div class="card-body">
                         ...
                         <form action="rotractpmlink.php" method="post" enctype="multipart/form-data" name="upload">
                                       
                          <div class="form-group">
                          <label>Select Month</label>
                           <?php
                       include "dbConfig/dbconfig.php";
                       $sql = "select * from rotractpmonth where status='process' order by pid desc";
