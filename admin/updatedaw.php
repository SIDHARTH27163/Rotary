  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="phfid" value="<?php echo $row['id'] ?>">
            <div class="modal-body">
        
         <div class="form-group">
         <label> Name</label>
          <input type="text" name="phfn" class="form-control" value="<?php echo $row['name']?>"  required>
        ...
        <div class="form-group">
         <label> Award For</label>
          <input type="text" name="phfn1" class="form-control" value="<?php echo $row['aw']?>"  required>
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="daw_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
