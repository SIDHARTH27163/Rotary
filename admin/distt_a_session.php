...
<head>
  ...
  <title>Dsitt. Award Session : CP  | Rotary Club Of Dharamshala</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add Distt. Award Session: Control Panel</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">DA</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                      ...
                      $query_session = "SELECT * FROM da_session Where d_session='$b_session'";
                      ...
                      $query="INSERT INTO da_session(d_session,date,status) VALUES ('$b_session',Now(),'$status')";
                      ...
                      if($query_run)
                        {
                          ...
                          echo " <div class='alert alert-success mydiv'>Your New Session for DA Is Successfully Added. Go For Step 2.</div>";
                        }
                        else
                        {
              ...
              <section class="content">
                    ...
                    <div class="card">
                      <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 1.</b> Add DA Session.</h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                                              ...
                                              <hr>
                                              <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 2.</b> Choose session year to add DA. </h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                      
                      
                                            <form action="dalink.php" method="post" enctype="multipart/form-data" name="upload">
