<div class="modal fade" id="AdminModal<?php echo $row['iid']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="dm_id" value="<?php echo $row['iid'] ?>">
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="it_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
