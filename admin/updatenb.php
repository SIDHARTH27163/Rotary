  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="update_album">Update NATION BUILDER AWARDEE</h5>
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="dm_id" value="<?php echo $row['id'] ?>">
          ...
          <input type="text" name="designation" class="form-control" value="<?php echo $row['org'] ?>"  required>
         <p class="help-block">Example "School Name"</p>
        </div>
        <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="nb_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
