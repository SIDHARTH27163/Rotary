  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="update_album">Update Board Of Directors Details</h5>
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="bod_id" value="<?php echo $row['Id'] ?>">
            <div class="modal-body">
                 <div class="form-group">
            <label> Member Id</label>
          <input type="text" name="mem_id" class="form-control" value="<?php echo $row['Mem_id'] ?>"  required>
         <p class="help-block">Example "8745856"</p>
        </div>
            <div class="form-group">
            <label> Designation</label>
          <input type="text" name="designation" class="form-control" value="<?php echo $row['designation'] ?>"  required>
         <p class="help-block">Example "President"</p>
        </div>
        <div class="form-group">
          <label> Name</label>
        ...
        <label> Mobile/Phone</label>
          <input type="text" name ="contact"  class="form-control" value="<?php echo $row['contact']?>" pattern="[0-9]{10}" placeholder="enter Mobile number" >
          <p class="help-block">Example: 9876543210 Only 10 digits without country code.</p> 
        </div>
      
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
        <button type="submit" name="bod_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
