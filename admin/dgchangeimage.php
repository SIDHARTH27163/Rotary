...
<head>
  ...
  <title>District Governers Image Edit | Rotary Club Dharamshala</title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>District Governer : Image Updater</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">RCD : District Governer Image Updater</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
if(isset($_POST['submit']))
   ...
   $query= "UPDATE dist_governers SET images='$edit_images' WHERE id = '$mykey1'";
            ...
            if($query_run)
      {
         move_uploaded_file($filetmp,$location.$edit_images);
                        ...
                        echo "<script>location.href='viewdg.php?ids=$asid2'</script>";
      }
