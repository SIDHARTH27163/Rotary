...
$sql = "select * from our_causes where ocid='$agid'";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add <?php echo $aname ?> Details</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active"><?php echo $aname ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content grid">
              ...
              if(isset($_POST['submit']))
              {
                   ...
                   $subh = $_POST['subh'];
                    ...
                    $query="INSERT into ocdet(`ocid`,`title`,`subh`,`descr`,`date`,`status`) VALUES('$gid','$gname','$subh','$descr','$gdate','$status')";
                  $query_run= mysqli_query($connection,$query);
                        ...
                        if($query_run){
                echo " <div class='alert alert-success mydiv'>Data  Successfully Uploded. <a href='viewphotos.php'>View Photos</a> |<a href='addevent.php'> Add new Photos</a></div>";
                      ...
                      <div class="card-body">
                        <form action="#" method="post" enctype="multipart/form-data" name="upload">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="subh" placeholder="Enter Sub Heading" required class="form-control" />
                
                                            <p class="help-block">Example "Enter Sub Heading"</p>
                                        </div>
                                        <div class="form-group">
