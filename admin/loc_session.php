  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add Contributors Session: Control Panel</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Contributors</li>
                      ...
                      $query_session = "SELECT * FROM cb_session Where c_session='$b_session'";
                      ...
                      $query="INSERT INTO cb_session(c_session,date,status) VALUES ('$b_session',Now(),'$status')";
              ...
              <section class="content">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                                              ...
                                              <hr>
                                              <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 2.</b> Choose session year to add Contributors. </h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                      
                      
                                            <form action="conlink.php" method="post" enctype="multipart/form-data" name="upload">
...
?>
                       ...
                       $sql = "select * from cb_session where status='process'";
                      ...
                      {
                      echo "<option value=$row[id]>$row[c_session]</option>";
