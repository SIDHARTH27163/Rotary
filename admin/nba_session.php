...
<head>
  ...
  <title>Nation Builer Award: CP  | Rotary Club Of Dharamshala</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Nation Builder Award Session: Control Panel</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">NBA</li>
                      ...
                      $query_session = "SELECT * FROM nba_session Where nb_session='$b_session'";
                      ...
                      $query="INSERT INTO nba_session(nb_session,date,status) VALUES ('$b_session',Now(),'$status')";
                      ...
                      if($query_run)
                        {
                          ...
                          echo " <div class='alert alert-success mydiv'>Your New Session for Nation Builder Award Is Successfully Added. Go For Step 2.</div>";
                        }
                        else
                        {
              ...
              <section class="content">
                    ...
                    <div class="card">
                      <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 1.</b> Add Nation Builder Award Session.</h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                                              ...
                                              <hr>
                                              <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 2.</b> Choose session year to add Nation Builder Awardee. </h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
...
?>
                       ...
                       $sql = "select * from nba_session where status='process'";
                      ...
                      {
                      echo "<option value=$row[id]>$row[nb_session]</option>";
