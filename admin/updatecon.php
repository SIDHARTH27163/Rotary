<div class="modal fade" id="AdminModal<?php echo $row['conid']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="update_album">Update Contributors Details</h5>
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="phfid" value="<?php echo $row['conid'] ?>">
         ...
         <div class="form-group">
        <label> Amount</label>
          <input type="text" name="comment" class="form-control" value="<?php echo $row['amount'] ?>"  required>
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="con_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
