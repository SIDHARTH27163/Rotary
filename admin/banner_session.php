...
<head>
  ...
  <title>Banner Session : CP  | Rotary Club Of Dharamshala</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Banner Session: Control Panel</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">Banner Session</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                      ...
                      $query_session = "SELECT * FROM rebanners_session Where bannersession= '$b_session'";
                      ...
                      $query="INSERT INTO rebanners_session(bannersession,status) VALUES ('$b_session','$status')";
              ...
              <section class="content">
                    ...
                    <div class="card">
                      <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 1.</b> Add Banners Year.</h3>
                        <a href = "vsbanners.php" class="float-right"><input type="Submit" name="import" value="View Banners" class="btn btn-primary" ></a>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
...
<button type="reset" class="btn btn-default">Reset Button</button>
                                              ...
                                              <hr>
                                              <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 2.</b> Choose  year to add Banners. </h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
...
?>
                       ...
                       $sql = "select * from rebanners_session where status='process' order by id desc";
                      ...
                      {
                      echo "<option value=$row[id]>$row[bannersession]</option>";
