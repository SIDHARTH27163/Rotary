<div class="modal fade" id="AdminModal<?php echo $row['projectid'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="projectcode.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
          ...
          <input type="text" name="page_link" class="form-control" value="<?php echo $row['page_link'] ?>" placeholder="Enter Album Page Link" required>
