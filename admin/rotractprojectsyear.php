...
<head>
  ...
  <title>Projects : CP  | Rotaract Club Of Dharamshala</title>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Projects</li>
                      ...
                      $query_session = "SELECT * FROM rotractprojectyear Where projectyear= $b_session";
                      ...
                      $query="INSERT INTO rotractprojectyear(projectyear,status) VALUES ('$b_session','$status')";
...
?>
                       ...
                       $sql = "select * from rotractprojectyear where status='process' order by id desc";
