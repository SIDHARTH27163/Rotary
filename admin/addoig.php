  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add Old Is Gold Images</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">Add Old Is Gold Images</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content grid">
                  ...
                  if(!in_array($extension_check,$allowed_extensions))
                          {
                           echo " <div class='alert alert-danger mydiv'><strong>ERROR</strong> - Invalid format. Only jpg / jpeg/ png /gif format allowed</div>";
                               ...
                               else
                               {
                                ...
                                $query="INSERT into oig(`images`,`date`,`status`) VALUES('$file_name','$gdate','$status')";
      ...
      <div class="card">
                      <div class="card-header bg-dark">
                        ...
                        <a href="viewmedia.php"><input type="button" name="media" class="float-right btn btn-primary" value="View Media"></a>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
