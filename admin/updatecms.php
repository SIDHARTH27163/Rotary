    ...
    <div class="modal-content">
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <label> Served as</label>
          <input type="text" name ="served"  class="form-control" value="<?php echo $row['served']?>"  placeholder="CMSRID Serves as" required>
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="cms_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
    ...
    if(isset($_POST['cms_update']))
     {
      ...
      if($query_run)
      {
                        ...
                        echo "<script>alert('Data updated Successfully.')</script>";
                        echo"<script>window.location.href ='viewcmsrid.php'</script>";
