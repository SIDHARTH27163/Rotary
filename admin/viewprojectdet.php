...
$sql = "select * from projectyear where id='$agid'";
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                           ...
                           <?php
                              ...
                              include"./dbConfig/dbconfig.php";
                              $query = "select * from projectdet where status='process' and aid='$agid' ORDER BY pdid DESC";
       ...
       <td> <?php echo $row2['description'] ?> </td>
            ...
            <td>
              ...
              <button class="btn btn-primary" data-toggle="modal" type="button" data-target="#AdminModal<?php echo $row2['pdid']?>">Edit</button>
                  ...
                  <td>
                  <form action="delete_project.php?id=<?php echo $row2['pdid']?>" onclick="return confirm('Are you sure you wish to delete this Album ?');" method="POST"> 
