...
<head>
  ...
  <title>Add images to Media  | RCD Media</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add Media Images</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">Add Media Images</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content grid">
                  ...
                  if(!in_array($extension_check,$allowed_extensions))
                          {
                           echo " <div class='alert alert-danger mydiv'><strong>ERROR</strong> - Invalid format. Only jpg / jpeg/ png /gif format allowed</div>";
                               ...
                               else
                               {
                                ...
                                $query="INSERT into media(`sid`,`images`,`date`,`status`) VALUES('$b_session','$file_name','$gdate','$status')";
      ...
      <div class="card">
                      <div class="card-header bg-dark">
                        <h3 class="card-title  ">Fill this form to add Images to Media Page: <span class="text-danger"> Multiple selection is also possible</span> </h3>
