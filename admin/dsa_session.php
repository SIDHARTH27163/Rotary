...
<head>
  ...
  <title>Manage DSVA : CP | Rotary Club Of Dharamshala</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Manage DSVA: Control Panel</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">DSVA</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                      ...
                      $query_session = "SELECT * FROM d_award_session Where dstserv_session='$b_session'";
                      ...
                      $query="INSERT INTO d_award_session(dstserv_session,date,status) VALUES ('$b_session',Now(),'$status')";
                      ...
                      if($query_run)
                        {
                          ...
                          echo " <div class='alert alert-success mydiv'>Your New Session for DSVA Is Successfully Added. Go For Step 2.</div>";
                        }
                        else
                        {
              ...
              <section class="content">
                    ...
                    <div class="card">
                      <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 1.</b> Add DSVA Session.</h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                      ...
                      <div class="card-body">
                                            ...
                                            <form action="dsalink.php" method="post" enctype="multipart/form-data" name="upload">
...
?>
                       ...
                       $sql = "select * from d_award_session where status='process'";
                      ...
                      {
                      echo "<option value=$row[id]>$row[dstserv_session]</option>";
