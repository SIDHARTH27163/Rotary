<div class="modal fade" id="AdminModal<?php echo $row['phfid']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="update_album">Update PAUL HARRIS FELLOWS Details</h5>
      ...
      <form action="" method="post" enctype="multipart/form-data">
        <span name="message"><?php 
      //Updatation code:
     
    ?></span>

        <input type="hidden" name="phfid" value="<?php echo $row['phfid'] ?>">
            <div class="modal-body">
        
         <div class="form-group">
         <label> Name Of The PHF</label>
          <input type="text" name="phfn" class="form-control" value="<?php echo $row['phfn']?>"  required>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="phf_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
