  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="update_album">Update Honrary Members Details</h5>
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <label>Session - Year</label>
          <input  type="text" name ="session"  class="form-control" value="<?php echo $row['session'] ?>"   pattern="[0-9]{4}-[0-9]{2}"+">
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="hm_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
