...
<head>
  ...
  <title>Rotary Club Dharamshala - Updates  | Events Cover</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Cover</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                      ...
                      $query="INSERT INTO event_cover(event_name,event_cover,status) VALUES ('$aname','$images','$status')";
