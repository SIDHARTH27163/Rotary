...
<head>
  ...
  <title>Rotary Club Dharamshala - Updates  | Interact  Events Cover</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add  Interact Events Cover</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">Add  Interact Events Cover</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                      ...
                      $query="INSERT INTO i_cover(sid,ievent_name,ievent_cover,status) VALUES ('$bname','$aname','$images','$status')";
