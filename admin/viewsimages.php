  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Rotary Club Of Dharamshala : Gallery</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">RCD : Gallery</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
       ...
       <!-- Main content -->
            ...
            $sql = "select * from tbl_gallery where status='process' and aid='$asid' ORDER BY gid DESC"; $query_run = mysqli_query($connection,$sql);
       ...
       <td> <?php echo $row["gimages"]; ?> </td>
                    ...
                    <td><a href='gchangeimage.php?key0=<?php echo  $row["gid"];?>&asid=<?php echo $row["aid"]; ?>'><img src="uploads/admin/Gallery/gupload/<?php echo $row['gimages']; ?>"  width="100px"/></a></td>
                  
                  <td>
                  <form action="albumcode.php" onclick="return confirm('Are you sure you wish to delete this Album ?');" method="POST"> 
                      <input type="hidden" name="delete_gid" value="<?php echo $row['gid'] ?>">
