...
<head>
  ...
  <title> Rotary Club Dharamshala - Admin | Rotary Event Banners</title>
...
<?php };?>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add Rotary Event Banners</h1>
          </div>
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">Banner Of The Year</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
          ...
          <div class="card">
            <div class="card-header bg-dark">
              <h3 class="card-title">Add Rotary Event Banners </h3>
              ...
              if(isset($_POST["import"]))
{
 ...
 $allowed_extension = array("jpeg", "jpg", "gif", "mp4" , "png" , "wmv" , "m4v" , "flv"); //allowed extension
   ...
   if(!in_array($extension_check,$allowed_extension))
      ...
      $query = "INSERT INTO rebanners(sid,name,images,date,status) VALUES ('".$bname."','".$name."', '".$file."',NOW(),'".$status."')";
      $query_run = mysqli_query($connection,$query);
     
      if($query_run){
      $message = '<div class="alert alert-success mydiv">Banner inserted Successfully!</div>';

      $target_dir = "uploads/admin/Gallery/rebanners/"; //file upload folder
