...
<?php 
    ...
    <section class="content-header">
      <div class="container-fluid">
       ...
       <!-- Main content -->
            ...
            $sql = "select * from com_mem where status='process' and session='$name'";
             $query_run = mysqli_query($connection,$sql);
            $Srno=1;
            $cid1=$name;
         ...
         ?>
            ...
            <th> Year</th>
            <th> List name</th>
            <th> Commettiee Chair</th>
            <th> Vice Comm. Chair</th>
            <th> Commettiee Members</th>
            <th> Edit</th>
                </tr>
                </thead>
                <tbody>
  ...
  <td> <?php echo $row["cchair"]; ?> </td>
  <td> <?php echo $row["vchair"]; ?> </td>
  <td> <?php echo $row["cmm"]; ?> </td>
  <td>
    <button class="btn btn-primary" data-toggle="modal" type="button" data-target="#AdminModal<?php echo $row['mid']?>">Edit</button>
  </td>
              
            </tr>
          
         <?php  
                 include 'updatecomm.php';
                }
