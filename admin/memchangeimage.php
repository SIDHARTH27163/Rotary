...
<head>
  ...
  <title>Members Details Image Edit | Rotary Club Dharamshala</title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Members Detials : Image Updater</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">RCD : Members Image Updater</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
if(isset($_POST['submit']))
   ...
   $query= "UPDATE members SET image='$edit_images' WHERE mid = '$mykey1'";
            ...
            if($query_run)
      {
         move_uploaded_file($filetmp,$location.$edit_images);
                        ...
                        echo "<script>location.href='viewmembers.php'</script>";
      }
