<div class="modal fade" id="AdminModal<?php echo $row['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="update_album">Update OUR CAUSES Details</h5>
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <label> Sub-Heading</label>
          <textarea name="subh" rows="" placeholder="Enter Description"  maxlength="10000" class="form-control" required><?php echo $row['subh'] ?></textarea>
        <p class="help-block" style="font-weight:italic">Max 10000 Character Allowed.   <span class="text-warning">   NOTE:</span> Use spaces between words and also make new lines b/w paragraphs. </p> 
        </div>
        ...
        <label> Description</label>
          <textarea name="description" rows="" placeholder="Enter Description"  maxlength="10000" class="form-control" required><?php echo $row['descr'] ?></textarea>
        <p class="help-block" style="font-weight:italic">Max 10000 Character Allowed.   <span class="text-warning">   NOTE:</span> Use spaces between words and also make new lines b/w paragraphs. </p> 
        </div>
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="ocd_update" class="btn btn-success">Update</button>
      </div>
    </form>
  </div>
</div>
