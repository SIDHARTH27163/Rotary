  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="dm_id" value="<?php echo $row['id'] ?>">
        ...
        <label> Mobile/Phone</label>
          <textarea name="description" row="" placeholder="Enter Description"  maxlength="10000" class="form-control" required><?php echo $row['description'] ?></textarea>
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="dmem_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
