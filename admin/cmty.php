...
<head>
  ...
  <title>RCD  Club Committes : CP  | Rotary Club Of Dharamshala</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add Club Committes Session: Control Panel</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">CC</li>
                      ...
                      $query_session = "SELECT * FROM com_session Where cm_session='$b_session'";
                      ...
                      $query="INSERT INTO com_session(cm_session,date,status) VALUES ('$b_session',Now(),'$status')";
              ...
              <section class="content">
                    ...
                    <div class="card">
                      <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 1.</b> Add Committe Session.</h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                                              ...
                                              <hr>
                                              <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 2.</b> Choose session year to add Club Commetties. </h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                      
                      
                                            <form action="comlink.php" method="post" enctype="multipart/form-data" name="upload">
...
?>
                       ...
                       $sql = "select * from com_session where status='process'";
                      ...
                      {
                      echo "<option value=$row[id]>$row[cm_session]</option>";
