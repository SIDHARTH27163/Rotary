          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Album</li>
                      ...
                      $query="INSERT INTO tbl_album(sid,name,adesc,image,date,status) VALUES ('$sid','$aname','$adesc','$images','$adate','$status')";
                      ...
                      if($query_run)
                        {
                          ...
                          echo " <div class='alert alert-success mydiv'>Your New Album Is Successfully Added. <a href='viewallalbums.php'>View albums</a> |<a href='addalbum.php'> Add new album</a></div>";
                        }
                        else
                        {
