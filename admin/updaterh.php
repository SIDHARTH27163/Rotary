<div class="modal fade" id="AdminModal<?php echo $row['rid'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="update_album">Update ROLL OF HONOR Details</h5>
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <label> YEAR</label>
          <input type="text" name="year" class="form-control" value="<?php echo $row['year']  ?>" pattern ="[0-9]{4}-[0-9]{2}" required>
         ...
         <label> President</label>
          <input type="text" name="president" class="form-control" value="<?php echo $row['president']?>"  required>
        ...
        <label> Secretary</label>
          <input type="text" name="secretary" class="form-control" value="<?php echo $row['secertary'] ?>"  required>
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="rh_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
