...
<head>
  ...
  <title>News Letters : CP| Rotary Club Dharamshala</title>
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">RCD : News Letters</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <section class="content">
                    ...
                    <div class="card">
                      <div class="card-header bg-dark">
                        <h3 class="card-title  ">News Letters Control Panel </h3>
                        <a href="newsletters.php" class="float-right"><input type="submit" class="btn btn-primary" value="Add News Letters"></a>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                        <?php
    ...
    ?>
                           ...
                           <?php
                              ...
                              include"./dbConfig/dbconfig.php";
                              $query = "select * from newsletters where status='process' ORDER BY id DESC";
                              $query_run = mysqli_query($connection,$query);
