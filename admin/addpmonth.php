...
<head>
  ...
  <title>Rotary Club Dharamshala - Updates  | Project</title>
...
<body>
 ...
 $query="INSERT INTO pmonth(pid,name,image,date,status) VALUES ('$pid','$aname','$images','$adate','$status')";
              ...
              <section class="content">
                    ...
                    <div class="card">
                      <div class="card-header bg-dark">
                        ...
                        <a href="addprojects.php"><input type="button" name="addp" class="float-right btn btn-primary" value="Add Projects"></a>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
