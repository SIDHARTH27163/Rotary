  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="update_album">Update Club Commetties Lists Details</h5>
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="phfid" value="<?php echo $row['id'] ?>">
         ...
         <label> List Name</label>
          <input type="text" name="phfn" class="form-control" value="<?php echo $row['listname']?>"  required>
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="coml_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
