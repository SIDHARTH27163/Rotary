...
<head>
  ...
  <title>Event Control Panel | Rotary Club Dharamshala</title>
...
if(isset($_POST['submit']))
      ...
      $extension = explode('.',$edit_images);
                      ...
                      $allowed_extensions = array("jpg","jpeg","png","gif");
                       ...
                       if(!in_array($extension_check,$allowed_extensions))
                          {
                           echo " <div class='alert alert-danger'><strong>ERROR</strong> - Invalid format. Only jpg / jpeg/ png /gif format allowed</div>";
   ...
   $query= "UPDATE event_desc SET images='$edit_images' WHERE id = '$mykey1'";
            ...
            if($query_run)
      {
        $images= md5($edit_images).'.'.$extension_check;
         move_uploaded_file($filetmp,$location.$edit_images);
                        ...
                        echo "<script>location.href='viewevents.php?ids=$asid2'</script>";
      }
