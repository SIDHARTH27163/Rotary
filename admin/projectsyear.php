...
<head>
  ...
  <title>Projects : CP  | Rotary Club Of Dharamshala</title>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Projects</li>
                      ...
                      $query_session = "SELECT * FROM projectyear Where projectyear= $b_session";
                      ...
                      $query="INSERT INTO projectyear(projectyear,status) VALUES ('$b_session','$status')";
              ...
              <section class="content">
                    ...
                    <div class="card">
                      <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 1.</b> Add Projects Year.</h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                                              ...
                                              <hr>
                                              <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 2.</b> Choose  year to add Projects. </h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                      
                      
                                            <form action="projectyearlink.php" method="post" enctype="multipart/form-data" name="upload">
...
?>
                       ...
                       $sql = "select * from projectyear where status='process' order by id desc";
