  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="update_album">Update Rotract Team Details</h5>
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="dm_id" value="<?php echo $row['rid'] ?>">
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="rt_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
