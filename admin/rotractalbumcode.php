    ...
    // ################################## Update Code for admin############################################
     ...
     $query = "UPDATE rotracttbl_album SET name='$edit_title',adesc='$edit_desc',image='$edit_images' WHERE albumid='$edit_id'";
...
// #############################deleteCode fo album#################################################
     if(isset($_POST['delete_album']))
     {
      ...
      $query = "DELETE FROM rotracttbl_album WHERE albumid='$id'";
            ...
            if($query_run)
      {
                     echo "<script>alert('Data Deleted Successfully.')</script>";
                        echo"<script>window.location.href ='rotractviewalbum.php'</script>";
      }
      else
      {
...
if(isset($_POST['delete_gallery']))
     {
      ...
      $query = "DELETE FROM rotracttbl_gallery WHERE gid='$id'";
            ...
            if($query_run)
      {
                 echo "<script>alert('Image Deleted Successfully.')</script>";
                        echo"<script>window.location.href ='rotractviewsgallery.php'</script>";
      }
      else
      {
                  echo "<script>alert('Data not Deleted!')</script>";
