<div class="modal fade" id="AdminModal<?php echo $row['mid']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="update_album">Update Club Commettiees Members Details</h5>
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="phfid" value="<?php echo $row['mid'] ?>">
            <div class="modal-body">
        
         <div class="form-group">
         <label> Commettiee Chair</label>
          <input type="text" name="phfn" class="form-control" value="<?php echo $row['cchair']?>"  required>
        ...
        <div class="form-group">
         <label> Vice Chair</label>
          <input type="text" name="phfn1" class="form-control" value="<?php echo $row['vchair']?>"  required>
        ...
        <div class="form-group">
         <label> Vice Chair</label>
          <input type="text" name="phfn2" class="form-control" value="<?php echo $row['cmm']?>"  required>
      ...
      <div class="modal-footer">
        ...
        <button type="Submit" name="comm_update" class="btn btn-success">Update</button>
      </div>
      </form>
    </div>
  </div>
