  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Gallery View Session: Control Panel</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">Gallery View  Session</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <section class="content">
                    ...
                    <div class="card">
                      ...
                      <!-- /.card-header -->
                        ...
                        <h3 class="card-title  "> Choose  year to View Gallery. </h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                      
                      
                                            <form action="abcgallerylink.php" method="post" enctype="multipart/form-data" name="upload">
