...
<head>
  ...
  <title>Hornary Members Image Edit | Rotary Club Dharamshala</title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Hornary Members : Image Updater</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="home.php">Home</a></li>
              <li class="breadcrumb-item active">RCD : HM Image Updater</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
if(isset($_POST['submit']))
   ...
   $query= "UPDATE hrnm SET image='$edit_images' WHERE id = '$mykey1'";
