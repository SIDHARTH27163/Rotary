        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">RCD : R Events</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
if(isset($_POST['submit']))
   ...
   $query= "UPDATE ievent_desc SET images='$edit_images' WHERE id = '$mykey1'";
            ...
            if($query_run)
      {
        $images= md5($edit_images).'.'.$extension_check;
         move_uploaded_file($filetmp,$location.$edit_images);
                        ...
                        echo "<script>location.href='viewievents.php?ids=$asid2'</script>";
      }
