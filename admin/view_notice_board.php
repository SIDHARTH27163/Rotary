...
<head>
  ...
  <title>Latest News : CP| Rotary Club Dharamshala</title>
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">RCD : Latest news</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <section class="content">
                    ...
                    <div class="card">
                      <div class="card-header bg-dark">
                        <h3 class="card-title  ">Latest News Control Panel </h3>
                        <a href="add_notice_board.php" class="float-right"><input type="submit" class="btn btn-primary" value="Add Latest News"></a>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                        <?php
    ...
    ?>
                           ...
                           <?php
                              ...
                              include"./dbConfig/dbconfig.php";
                              $query = "select * from notice_board where status='process' ORDER BY id DESC";
                              $query_run = mysqli_query($connection,$query);
    ...
    <tr>
      <td> <?php echo $Srno++ ; ?> </td>
       <td> <?php echo $row["Title"]; ?> </td>
            <td><center><img  height="150px;" width="150px;" src="<?php echo $location.$row['file']?>"></center></td>
                  <td>
