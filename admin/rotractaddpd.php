...
$sql = "select * from rotractpmonth where pid='$agid'";
    ...
    <section class="content grid">
                  ...
                  if(!in_array($extension_check,$allowed_extensions))
                          {
                           echo " <div class='alert alert-danger mydiv'><strong>ERROR</strong> - Invalid format. Only jpg / jpeg/ png /gif format allowed</div>";
                               ...
                               else
                               {
                                ...
                                $query= "INSERT INTO `rotractprojectdet`(`aid`, `gname`, `title`, `description`, `gimages`, `date`, `status`)VALUES('$gid','$gname','$title','$adesc','$file_name','$gdate','$status')";
      ...
      <div class="card">
                      <div class="card-header bg-dark">
                        ...
                        <a href="rotractprojectsyear.php"><input type="button" name="year" value="Add New Year" class="float-right btn btn-primary"></a>
