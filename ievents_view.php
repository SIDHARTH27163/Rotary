...
<head>
    ...
    <title>Interacts Events View | Rotary Club of Dharamshala</title>
...
<section id="top_banner">
      <div class="banner">
         <div class="inner text-center"> 
            <h2 id="banner-text">Interacts Events</h2>
         </div>
        </div>
        <div class="page_info">
            <div class="container">
...
$sql = "SELECT * FROM i_cover where reid='$aid'";
            ...
            <div class="row">
              <table id="AdminData" class="table table-bordered table-striped">
                  ...
                  <?php include './admin/dbConfig/dbconfig.php';
                    $query = "SELECT * FROM ievent_desc where ieid=$aid and status='process' LIMIT 1";
                     $query_run = mysqli_query($connection,$query);
                     $location= "admin/uploads/admin/Gallery/ievent_images/";
...
<tbody>
  <tr>
                <td>
              <?php include './admin/dbConfig/dbconfig.php';
                    $query = "SELECT * FROM ievent_desc where ieid=$aid and status='process'";
                     $query_run = mysqli_query($connection,$query);
                     $location= "admin/uploads/admin/Gallery/ievent_images/";
                ...
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 portfolio-item">
                  ...
                  <tfoot class="bg-dark">
                   <tr> <th><a href="interactsevents.php"<i style='color:white;'class='fa fa-arrow-circle-o-left' aria-hidden='true'></i>  Back</a></th></tr>
                  </tfoot>
                  </table>
