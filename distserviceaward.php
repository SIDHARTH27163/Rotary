...
{
 $output ='';
 $query= "SELECT DISTINCT srvcawd_session from dstserawrd ORDER BY srvcawd_session DESC";
 $result = mysqli_query($connection,$query);

 while($row = mysqli_fetch_array($result))
 {

  $output .='<option value="'.$row["srvcawd_session"].'">'.$row["srvcawd_session"].'</option>';
 }
 return $output; 
...
<head>
    ...
    <title>District Service Award</title>
 ...
 <section id="top_banner">
        <div class="banner">
            <div class="inner text-center">
                <h2 id="banner-text">District Service Award</h2>
            </div>
        </div>
    ...
    <section id="features" style="padding-bottom:2px;">
        <div class="container">
            ...
            <div class="card-header">
              <center><h2 class="card-title">District<span> Service</span> Award</span>
