...
{
 $output ='';
 $query= "SELECT DISTINCT p_session from phsm_session ORDER BY p_session DESC";
 $result = mysqli_query($connection,$query);

 while($row = mysqli_fetch_array($result))
 {

  $output .='<option value="'.$row["p_session"].'">'.$row["p_session"].'</option>';
 }
 return $output; 
 ...
 <section id="top_banner">
        <div class="banner">
            <div class="inner text-center">
                <h2 id="banner-text"> Paul Harris Sustaining Members</h2>
            </div>
        </div>
    ...
    <section id="features" style="padding-bottom:5px;">
        <div class="container">
            ...
            <div class="card-header">
              <center><h2 class="card-title"><span>Paul Harris<span> Sustaining Members</span> </span>
            ...
            <div class="row">
              <table id="example2" class="table table-bordered table-striped " >
                 ...
                 <thead>
                   <tr >
                    <th> Sr no.</th>
                    <th>Name of the Paul Harris Sustaining Member</th>
                   </tr>
                 </thead>
                 <tbody id="show_desig">
