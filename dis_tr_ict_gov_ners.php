...
{
 $output ='';
 $query= "SELECT DISTINCT d_session from dist_gov_session ORDER BY d_session DESC";
 $result = mysqli_query($connection,$query);

 while($row = mysqli_fetch_array($result))
 {

  $output .='<option value="'.$row["d_session"].'">'.$row["d_session"].'</option>';
 }
 return $output; 
...
<head>
    ...
    <title>District Governors | RCD</title>
 ...
 <section id="top_banner">
        <div class="banner">
            <div class="inner text-center">
                <h2 id="banner-text">District Governors</h2>
            </div>
        </div>
    ...
    <section id="features" style="padding-bottom:5px;">
        <div class="container">
            ...
            <div class="card-header">
              <center><h2 class="card-title">District Governer <span>RID 3070</span>
