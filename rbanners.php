...
$sql = "SELECT * FROM rebanners_session where id='$aid'";
...
<tbody>
  <tr>
             ...
             <?php
             include 'admin/dbConfig/dbconfig.php';
             $location= "admin/uploads/admin/Gallery/rebanners/";
$query = "SELECT * FROM rebanners where sid='$aname' ORDER BY bannerid DESC ";
    ...
    ?>
                  ...
                  <tfoot class="bg-dark">
                   <tr> <th><a href="rb@nners.php"<i style='color:white;'class='fa fa-arrow-circle-o-left' aria-hidden='true'></i>  Back</a></th></tr>
                  </tfoot>
                  </table>
