...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    header("location: updatemembersdetails.php");
    exit;
}
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT Id, username, password FROM membersignup WHERE username = ?";
...
<head>
  ...
  <link rel="icon" type="admin/image/gif/png" href="../img/title.png">
  <!-- Ionicons -->
...
<body class="hold-transition login-page" style="background-image: url('admin/images/backImage.jpg'");>
<div class="login-box">
  <div class="login-logo">
    <a href=""style="color:#fff;"><b style="color:#fff;">Member </b> | Log in</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body bg-dark">
     
      <h4 class="login-box-msg">Please Sign in</h4>
