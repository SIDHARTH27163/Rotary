...
{
 $output ='';
 $query= "SELECT DISTINCT nb_session from nba_session ORDER BY nb_session DESC";
 $result = mysqli_query($connection,$query);

 while($row = mysqli_fetch_array($result))
 {

  $output .='<option value="'.$row["nb_session"].'">'.$row["nb_session"].'</option>';
 }
 return $output; 
...
<head>
    ...
    <title>Nation Builder Award</title>
 ...
 <section id="top_banner">
        <div class="banner">
            <div class="inner text-center">
                <h2 id="banner-text">Nation Builder Award</h2>
            </div>
        </div>
    ...
    <section id="features" style="padding-bottom:2px;">
        <div class="container">
            ...
            <div class="card-header">
              <center><h2 class="card-title">Nation <span> Builder</span> Award</span>
