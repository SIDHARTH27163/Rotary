...
<head>
    ...
    <title>Gallery Old is Gold | Rotary Club of Dharamshala</title>
...
<section id="top_banner">
      <div class="banner">
         <div class="inner text-center"> 
            <h2 id="banner-text">Gallery OLD IS GOLD</h2>
         </div>
        </div>
        <div class="page_info">
            <div class="container">
                ...
                <h4>Gallery <span>OLD</span> IS  <span>Gold</span></h4>
                    </div>
                </div>
            </div>
        </div>
...
<tbody>
  <tr >
              ...
              <?php include './admin/dbConfig/dbconfig.php';
                    $query = "SELECT * FROM oig where  status='process' order by id desc";
                     $query_run = mysqli_query($connection,$query);
                     $location= "admin/uploads/admin/Gallery/oig/";
                    ...
                    <div class="portfolio-one">
                        <div class="portfolio-head">
                            <div class="portfolio-img">
                              <a href="<?php echo $location.$row['images']?>" data-lightbox="rcdGallery"  data-description="unknown">
