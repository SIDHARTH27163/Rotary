...
{
 $output ='';
 $query= "SELECT DISTINCT cd_session from cmsrid ORDER BY cd_session DESC";
 $result = mysqli_query($connection,$query);

 while($row = mysqli_fetch_array($result))
 {

  $output .='<option value="'.$row["cd_session"].'">'.$row["cd_session"].'</option>';
 }
 return $output; 
 ...
 <section id="top_banner">
        <div class="banner">
            <div class="inner text-center">
                <h2 id="banner-text">CLUB MEMBERS SERVING IN RID 3070</h2>
            </div>
        </div>
    ...
    <section id="features" style="padding-bottom:5px;">
        <div class="container">
            ...
            <div class="card-header">
              <center><h2 class="card-title">CLUB MEMBERS SERVING IN <span>RID 3070</span>
