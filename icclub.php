...
{
 $output ='';
 $query= "SELECT DISTINCT icsession from ic_session ORDER BY icsession DESC";
 $result = mysqli_query($connection,$query);

 while($row = mysqli_fetch_array($result))
 {

  $output .='<option value="'.$row["icsession"].'">'.$row["icsession"].'</option>';
 }
 return $output; 
 ...
 <section id="top_banner">
        <div class="banner">
            <div class="inner text-center">
                <h2 id="banner-text">Interact Club</h2>
            </div>
        </div>
    ...
    <section id="features">
        <div class="container">
            ...
            <div class="card-header">
              <center><h2 class="card-title">Interact <span>CLUB</span> 
               </h2>
               <br>
               <h4>Through Interact clubs, people ages 12-18 connect with others in their community or school and learn about the world through service projects and activities.</h4>
...
<script>
    ...
    <section id="features" style="padding: 5px;">
        <div class="container">
            <div class="card">
            <div class="card-header">
              <center><h2 class="card-title">Interact <span> TEAM </span>
    ...
    <section id="about-page-section-3" style="padding:0px;">
        <div class="container">
            ...
            <hr>
            <div class="row">
              <center><a href="inter@ctevents.php" class="btn btn-primary" name="rccevent" style="color:#000;" >Interact Projects / Events</a></center>
            </div>
            <br>
        </div>
    </section>
