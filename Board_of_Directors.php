...
<head>
  ...
  <title>Board Of Directors : CP  | Rotary Club Of Dharamshala</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Board of Directors: Control Panel</h1>
          </div>          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Board Of Directors</li>
                      ...
                      $query_session = "SELECT * FROM bod_session Where b_session='$b_session'";
                      ...
                      $query="INSERT INTO bod_session(b_session,date,status) VALUES ('$b_session',Now(),'$status')";
              ...
              <section class="content">
                    ...
                    <div class="card">
                      <div class="card-header bg-dark">
                        <h3 class="card-title  "><b>Step : 1.</b> Add Board of Directors Session.</h3>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                      ...
                      <div class="card-body">
                                            ...
                                            <form action="bodlink.php" method="post" enctype="multipart/form-data" name="upload">
...
?>
                       ...
                       $sql = "select * from bod_session where status='process'";
                      ...
                      {
                      echo "<option value=$row[bid]>$row[b_session]</option>";
