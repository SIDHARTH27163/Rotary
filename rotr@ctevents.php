...
<head>
    ...
    <title>Rotract Projects / Events | Rotary club of dharamshala</title>
        ...
        <div class="container">
            <div class="row">
              <table id="AdminData" class="table table-bordered table-striped">
                  <thead class="bg-dark">
                    <th class""><span> Rotract Club  : Projects / Events</span></th>
                </thead>
<tbody>
                <td>
              <?php include './admin/dbConfig/dbconfig.php';
                    $query = "SELECT * FROM rotract_session where status='process' ORDER BY id DESC";
                ...
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 portfolio-item">
                    <div class="portfolio-one">
                        ...
                        <div class="portfolio-content">
                            <h5 class="title"><span style="font-size: 35px;"><?php echo htmlentities($row['r_session']);?></span></h5>
                            <p><?php echo"<a href='rotractevents.php.php?id=$aid'> <button type='submit' class='btn btn-warning' name='view_more'>View   <i style='color:white;'class='fa fa-arrow-circle-o-right' aria-hidden='true'></i></button></a>"?></p>
