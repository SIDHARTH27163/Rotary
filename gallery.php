...
$sql = "SELECT * FROM gallery_session where id='$aid'";
...
<tbody>
  <tr>
              ...
              <?php include './admin/dbConfig/dbconfig.php';
                    $query = "SELECT * FROM tbl_album where sid = '$aname' ORDER BY albumid DESC";
                    ...
                    <div class="portfolio-one">
                        <div class="portfolio-head">
                            ...
                            <a href="<?php echo $location.$row['image']?>" data-lightbox="rcdGallery" data-title="<?php echo $row['name']?>">
                                <img class="img-responsive" alt="<?php echo $row['name']?>" src="<?php echo $location.$row['image']?>">
                            </div>
                        </div>
                        <!-- End portfolio-head -->
                        <div class="portfolio-content">
                          <h5 class="title"><span><?php echo htmlentities($row['name']);?></span></h5>
                            <p><?php echo"<a href='gallery_view.php?id=$aid'> <button type='submit' class='btn btn-warning' name='view_more'>View Gallery  <i style='color:white;'class='fa fa-arrow-circle-o-right' aria-hidden='true'></i></button></a>"?></p>
