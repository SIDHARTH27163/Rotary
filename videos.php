...
<head>
    ...
    <title>Videos| Rotary Club of Dharamshala</title>
...
$text = $row['link'];
    ?>
                ...
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 portfolio-item">
                   <iframe width="270" height="200" style="border: inset;" src="https://youtube.com/embed/<?php echo $text; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <!-- End portfolio-item -->
                </div>
                   <?php 
                        } 
