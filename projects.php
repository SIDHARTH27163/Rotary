...
<head>
    ...
    <title>Projects / Events | Rotary club of dharamshala</title>
        ...
        <div class="container">
            <div class="row">
              <table id="AdminData" class="table table-bordered table-striped">
                  <thead class="bg-dark">
                    <th class""><span> Rotary Club Of Dharamshala : Projects / Events</span></th>
                </thead>
<tbody>
                <td>
              <?php include './admin/dbConfig/dbconfig.php';
                    $query = "SELECT * FROM projectyear where status='process' ORDER BY id DESC";
                ...
                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 portfolio-item">
                    <div class="portfolio-one">
                        ...
                        <div class="portfolio-content">
                            ...
                            <p><?php echo"<a href='projectsview.php?id=$aid'> <button type='submit' class='btn btn-warning' name='view_more'>View  <i style='color:white;'class='fa fa-arrow-circle-o-right' aria-hidden='true'></i></button></a>"?></p>
