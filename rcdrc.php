 ...
 <section id="top_banner">
        <div class="banner">
            <div class="inner text-center">
                <h2 id="banner-text">ROTARY CITATION</h2>
            </div>
        </div>
    ...
    <section id="about-page-section-3">
        <div class="">
            ...
            $sql = "select * from rcdrc order by  id desc";
             $query_run = mysqli_query($connection,$sql);
             $location="admin/uploads/admin/Rotary_citation/";
            ...
            
            {
             ...
             ?>
              <div class="col-sm-4">
                  ...
                  <h2><span><?php echo $row['uploaded_on'] ?></span></h2>
                  <h4><?php echo $row['title'] ?></h4>
                  <a href="<?php echo $location.$row['image'] ?>" target="_blank"><img src="<?php echo $location.$row['image'] ?>" height="400px"; width="100%";></a>
