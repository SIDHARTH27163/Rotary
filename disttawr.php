...
{
 $output ='';
 $query= "SELECT DISTINCT d_session from da_session ORDER BY d_session DESC";
 ...
 <section id="top_banner">
        <div class="banner">
            <div class="inner text-center">
                <h2 id="banner-text"> District Awards</h2>
            </div>
        </div>
    ...
    <section id="features" style="padding-bottom:5px;">
        <div class="container">
            ...
            <div class="card-header">
              <center><h2 class="card-title"><span>District<span> Awards</span> </span>
